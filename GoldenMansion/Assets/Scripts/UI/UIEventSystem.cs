...
public class UIEventSystem : MonoBehaviour
{
    ...
    public void Execute()
    {
        ...
        EventQueueManager.Instance.RegisterEvent(ApartmentController.Instance.GenerateBasicCoin);
        EventQueueManager.Instance.RegisterEvent(SkillController.Instance.SkillTrigerControll);
