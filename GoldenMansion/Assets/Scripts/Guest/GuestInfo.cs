    ...
    void TranslateSelfTitle(string titleName, int languageID)
    {
        switch (languageID)
        {
            case 1:
                ...
                break;
            case 2: transform.Find(titleName).Find("Title").GetComponent<TextMeshProUGUI>().text = ButtonLanguageData.GetItem(transform.Find(titleName).Find("Title").GetComponent<TextMeshProUGUI>().text).ENG;
                break;
            case 3: transform.Find(titleName).Find("Title").GetComponent<TextMeshProUGUI>().text = ButtonLanguageData.GetItem(transform.Find(titleName).Find("Title").GetComponent<TextMeshProUGUI>().text).TCHN;
                break;
        }
