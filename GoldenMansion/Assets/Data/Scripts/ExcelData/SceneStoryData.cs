...
namespace ExcelData
{
    public class SceneStoryData : IDataSheet
    {
        public class Item
        {
            public int storyID;
        ...
        private static SceneStoryData s_Instance;
        private static SceneStoryData Instance
        {
            get
            {
                if (s_Instance == null)
                {
                    s_Instance = new SceneStoryData();
                    s_Instance.Init();
        ...
        public string sheetName => "SceneStoryData";
